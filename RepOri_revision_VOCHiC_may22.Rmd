...
par(oma=c(1,1,1,0))
par(mar=c(4,6,6,1))
#boxplot(abs(RTdif)[setdiff(names(RTdif), intere)],abs(RTdif)[intere], abs(randdif),varwidth=T, names=c('Intra-TAD', 'Inter-TAD', 'Random node pairs'), ylab='RT Difference between node pairs', cex.lab=3, cex.axis=2.5)
#dev.off()
