...
```
#### Load oris #### For PCHiC need mm9 oris
```{r}
...
plot(colMeans(netwt_bbfeat)[sel], netwt_bbchas[sel],  pch=21,bg=colssel, col='black', cex=2, cex.lab=2, xlab='Efficiency averaged over network nodes',     ylab='OriEfAs', ylim=c(-0.1,0.2), xlim=c(0,4))
for (i in 1:nrand){
